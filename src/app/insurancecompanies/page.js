...
const InsuranceCompaniesPage = dynamic(() => import('@/features/insurancecompanies/insuranceCompaniesPage'), {
    loading: () => <LoadingPage />,
});
...
export default function InsuranceCompanies() {
    ...
    if (error) {
        return <ErrorComponent message="Error loading insurance companies. Please try again later." />;
    }
